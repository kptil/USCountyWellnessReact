...
const nodbUtil = require('oracledb/lib/util.js');
...
const AqDeqOptions = require('oracledb/lib/aqDeqOptions.js');
const AqEnqOptions = require('oracledb/lib/aqEnqOptions.js');
const AqMessage = require('oracledb/lib/aqMessage.js');
const AqQueue = require('oracledb/lib/aqQueue.js');
const BaseDbObject = require('oracledb/lib/dbObject.js');
const Connection = require('oracledb/lib/connection.js');
const Lob = require('oracledb/lib/lob.js');
const Pool = require('oracledb/lib/pool.js');
const PoolStatistics = require('oracledb/lib/poolStatistics.js');
const ResultSet = require('oracledb/lib/resultset.js');
const SodaDatabase = require('oracledb/lib/sodaDatabase.js');
const SodaCollection = require('oracledb/lib/sodaCollection.js');
const SodaDocCursor = require('oracledb/lib/sodaDocCursor.js');
const SodaDocument = require('oracledb/lib/sodaDocument.js');
const SodaOperation = require('oracledb/lib/sodaOperation.js');
